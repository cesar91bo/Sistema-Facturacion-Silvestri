    ...
    public partial class frmConsultaClientes : Form
    {
        ...
        private void CrearColListCliente()
        {
            try
            {
                ...
                listCliente.Columns.Add("Ubicacion Caja", 90, HorizontalAlignment.Left);
            ...
            try
            {
                ...
                else
                {
                    if (Seleccion)
                    {
                        ...
                        {
                            return cliNegocio.ObtenerListClientesPorEstadoTotal(cmbEstados.Text);
                        }
                    }
                    else
                    {                       
        ...
        private void frmConsultaClientes_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
        ...
        private void SeleccionLv()
        {
            try
            {
                ...
                {
                    if (listCliente.SelectedItems[0].Text != "1")
                    {
                        var frmc = new frmNuevoCliente { Accion = "VER", NroCliente = Convert.ToInt32(listCliente.SelectedItems[0].Tag) };
                        frmc.ShowDialog();
                        LLenarListaCliente(true);
